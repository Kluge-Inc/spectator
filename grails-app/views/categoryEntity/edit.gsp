...
<html>
	...
	<body>
		<a href="#edit-categoryEntity" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-categoryEntity" class="content scaffold-edit" role="main">
			...
			<g:form url="[resource:categoryEntityInstance, action:'update']" method="PUT" >
